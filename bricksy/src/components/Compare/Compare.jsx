...
if(!items.length) return <div className='container' style={{padding:'1rem'}}>Add properties to compare.</div>
...
<div>Title</div><div>Price</div><div>Type</div><div>Bedrooms</div><div>Sqft</div><div>Amenities</div>
</div>
{items.map(p=> (
